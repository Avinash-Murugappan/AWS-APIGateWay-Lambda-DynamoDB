...
export class DataServiceService {
  ...
  private surveyServerGetRecordsUrl = 'https://tt90umiwkg.execute-api.us-east-1.amazonaws.com/prod/users';
  private surveyServerAddRecordsUrl = 'https://tt90umiwkg.execute-api.us-east-1.amazonaws.com/prod/users/put';
